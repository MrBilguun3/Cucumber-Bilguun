...
public class BooksTableStepDefs {
    ...
    public void i_edit_book_The_kiterunner(String book) {
        ...
        BrowserUtils.waitForClickability(booksPage.searchField, 5).sendKeys(book);
    ...
    public void i_verify_book_information(Book book) {
        ...
        System.out.println("booksPage.author.getAttribute(\"value\") = " + booksPage.author.getAttribute("value"));
